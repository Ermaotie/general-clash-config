...
CREATE TABLE IF NOT EXISTS devices (id TEXT PRIMARY KEY, name TEXT NOT NULL, token_hash TEXT UNIQUE NOT NULL, token_encrypted TEXT, revoked_at TEXT, created_at TEXT NOT NULL);
